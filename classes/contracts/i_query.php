 ...
 * @method i_query or_where(string $column, string $operator, $value)
 ...
 * @method i_query where_in(string $column, array|i_query $values)
 ...
 * @method i_query join(string|i_query $table, $conditions, string $alias = '')
 *         Join another table with INNER JOIN.
 * @method i_query left_join(string|i_query $table, $conditions, string $alias = '')
 *         Join another table with LEFT JOIN.
 * @method i_query right_join(string|i_query $table, $conditions, string $alias = '')
 *         Join another table with RIGHT JOIN.
 * @method i_query full_join(string|i_query $table, $conditions, string $alias = '')
 *         Join another table with FULL OUTER JOIN.
 * @method i_query group_by(string ...$column)
 *         Group results by one or more columns.
 * @method i_query having(string $column, string $operator, mixed $value)
 *         Add a HAVING condition for grouped queries.
 * @method i_query or_having(string $column, string $operator, mixed $value)
